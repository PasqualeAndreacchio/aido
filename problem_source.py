...
###############################################################################################################
    ...
    parameters2 = aido.SimulationParameterDictionary([
        aido.SimulationParameter("thickness_absorber_0", 30.0, min_value=min_value),
        aido.SimulationParameter("thickness_scintillator_0", 20.0, min_value=min_value),
        aido.SimulationParameter(
            "material_absorber_0",
            "G4_Fe",
            discrete_values=["G4_Pb", "G4_Fe"],
        ...
        aido.SimulationParameter("thickness_absorber_1", 40.0, min_value=min_value),
        aido.SimulationParameter("thickness_scintillator_1", 19.0, min_value=min_value),
        aido.SimulationParameter(
            "material_absorber_1",
            "G4_Fe",
            discrete_values=["G4_Pb", "G4_Fe"],
        ...
        aido.SimulationParameter("thickness_absorber_2", 3.0, min_value=min_value),
        aido.SimulationParameter("thickness_scintillator_2", 40.0, min_value=min_value),
        aido.SimulationParameter(
            "material_absorber_2",
            "G4_Fe",
            discrete_values=["G4_Pb", "G4_Fe"],
        ...
        aido.SimulationParameter("num_events", 800, optimizable=False),
        aido.SimulationParameter("max_length", 250, optimizable=False),
        aido.SimulationParameter("max_cost", 100_000, optimizable=False),
        aido.SimulationParameter("full_calorimeter", True, optimizable=False)
    ])

    sec_results_dir: str = "Second_calo_1407"
    os.system(f"rm -f /mnt/work/aido/Results/{sec_results_dir}")
    aido.optimize(
                ...
                max_iterations=60,
                threads=32,
                results_dir=f"/mnt/work/aido/Results/{sec_results_dir}",
                description="""
                Optimization of a sampling calorimeter with cost and length constraints.
                Includes the optimization of discrete parameters, specific plotting functions
                """
    ...
    ui2 = UIFullCalorimeter()
    ui2.results_dir = f"/mnt/work/aido/Results/{sec_results_dir}"
    ui2.plot(parameters2)
